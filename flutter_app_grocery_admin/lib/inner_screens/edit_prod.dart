...
import 'package:flutter_app_grocery_admin/screens/loading_manager.dart';
import 'package:flutter_app_grocery_admin/services/global_method.dart';
    ...
    if (isValid) {
      ...
      try {
        ...
        final ref = FirebaseStorage.instance
            ...
            .child('${widget.id}jpg');
        if (kIsWeb) {
          // For web, use putData() to upload the image
          ...
          // For mobile, use putFile() to upload the image
